 ...
 * Jose Manuel Garcia Nieto 20/05/2010
 * File : PSO.hh Header file for traffic lights problem
 * Definition of the PSO skeleton for Mallba
 * For the problem instance: TL
 *
 *****************************************************************
 **  ****************************/
...
skeleton PSO
{
    ...
    {
        public:
        Problem(int,int,int,int,char *,char *);
        ~Problem();
        ...
        int dimension() const;
        int n_tl_logic() const;
        Rarray<logic>& tl_logic();
        logic& tl_logic(int index) const;
        void tl_logic(int index, logic& t) const;
        int simulation_time () const;
        double x(const int i) const;
        void dimension(const int d);
        void n_tl_logic(const int n);
        void simulation_time (const int t);
        void x(const int index, const double value);
        double* x() const;
        char* path() const;
        char* instance() const;
        int n_vehicles() const;
        double best_cost() const;

        private:

        Rarray<logic> _tl_logic;
        int _n_tl_logic;
        int _dimension;
        double *_x;
...
provides class Swarm
{
    ...
    double constrict_variable(int pos, double x);
    double constrict(double v);
